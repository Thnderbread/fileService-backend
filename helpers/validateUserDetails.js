/**
 * Checks validity of a user's details via regex. Ensures matchPassword === password. 
 * @param {Object} details - Expects username, email, password, and matchPassword as an object.
 * @param {string} details.email - User's email.
 * @param {string} details.username - User's username.
 * @param {string} details.password - User's password.
 * @param {string} details.matchPassword - Value that should be equal to password.
